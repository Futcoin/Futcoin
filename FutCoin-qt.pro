...
macx {
    MINIUPNPC_INCLUDE_PATH=/usr/local/include/miniupnpc
    MINIUPNPC_LIB_PATH=/usr/local/lib/libminiupnpc.a
}

!windows:!macx {
    MINIUPNPC_INCLUDE_PATH=/usr/include/miniupnpc
    MINIUPNPC_LIB_PATH=/usr/lib/libminiupnpc.a
}
...
# use: qmake "RELEASE=1"
contains(RELEASE, 1) {
    # Mac: compile for moderate compatibility (10.7, 64-bit)
    macx:QMAKE_CXXFLAGS += -mmacosx-version-min=10.7 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -stdlib=libc++
...
macx:ICON = src/qt/res/icons/FutCoin.icns
macx:TARGET = "FutCoin-qt"
